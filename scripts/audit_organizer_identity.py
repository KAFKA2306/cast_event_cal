...
The audit is deliberately conservative: display-name equality is never sufficient to
merge organizers. A stable candidate requires an explicit strong identity key
(VRChat group or official HTTPS origin). Otherwise records stay ambiguous/distinct.
"""
